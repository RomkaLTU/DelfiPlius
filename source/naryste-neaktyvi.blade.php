...
@section('body')
    ...
    <div class="dp-flex dp-items-center dp-justify-center dp-bg-red-2 dp-text-20px dp-py-2 dp-mb-4">
        <div class="lg:dp-text-23px dp-text-red-1 dp-mr-2">
            <span class="dp-w-25px dp-h-25px dp-rounded-full dp-bg-red-1 dp-text-white dp-flex dp-items-center dp-justify-center dp-text-14px"><i class="far fa-times"></i></span>
        </div>
        <div class="dp-text-16px">Tavo prenumerata <span class="dp-text-red-1">neaktivuota</span></div>
    </div>
    <div class="dp-bg-gray-1 dp-p-30px lg:dp-p-40px dp-mb-8">
        ...
        <div class="dp-bg-white dp-border dp-border-gray-3 dp-p-47px dp-text-center">
            <div class="">
                <div class="dp-text-20px lg:dp-text-23px dp-font-medium">Pirmas mėnuo – 1€</div>
    ...
    <div class="dp-bg-gray-1 dp-p-30px lg:dp-p-40px dp-mb-8">
        ...
        <div class="dp-flex dp-flex-col lg:dp-flex-row dp-items-center dp-text-center lg:dp-text-left dp-border dp-border-gray-3 dp-bg-white dp-py-20px dp-mb-2">
            ...
            <div class="dp-flex-3 dp-mb-3">
                <div class="dp-font-medium dp-text-18px lg:dp-text-20px">1€ už 1-ąjį mėn.</div>
        ...
        <div class="dp-flex dp-flex-col lg:dp-flex-row dp-items-center dp-text-center lg:dp-text-left dp-border dp-border-gray-3 dp-bg-white dp-py-20px dp-mb-2">
            ...
            <div class="dp-flex-3 dp-mb-3">
                ...
                <div class="dp-font-medium dp-text-18px lg:dp-text-20px">9€ už 3 mėn.</div>
                <div class="dp-text-16px lg:dp-text-18px">po to – 5€/mėn.</div>
            </div>
            <div class="dp-flex-1 lg:dp-pr-8 dp-flex dp-items-center">
                @include('_partials.btn-yellow-small',['text'=>'Užsakyti'])
        ...
        <div class="dp-flex dp-flex-col lg:dp-flex-row dp-items-center dp-text-center lg:dp-text-left dp-border dp-border-gray-3 dp-bg-white dp-py-20px dp-mb-2">
            ...
            <div class="dp-flex-3 dp-mb-3">
                <div class="dp-font-medium dp-text-18px lg:dp-text-20px">15€ už 6 mėn.</div>
                <div class="dp-text-16px lg:dp-text-18px">po to – 5€/mėn.</div>
            </div>
            <div class="dp-flex-1 lg:dp-pr-8 dp-flex dp-items-center">
                @include('_partials.btn-yellow-small',['text'=>'Užsakyti'])
